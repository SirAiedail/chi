...
func Profiler() chi.Handler {
	...
	r.Handle("/pprof/block", chi.FromHTTPHandler(pprof.Handler("block")))
	r.Handle("/pprof/heap", chi.FromHTTPHandler(pprof.Handler("heap")))
	r.Handle("/pprof/goroutine", chi.FromHTTPHandler(pprof.Handler("goroutine")))
	r.Handle("/pprof/threadcreate", chi.FromHTTPHandler(pprof.Handler("threadcreate")))
