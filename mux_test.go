...
func TestMuxNestedMethodNotAllowed(t *testing.T) {
	...
	pathVar := NewRouter()
	pathVar.Get("/{var}", func(w http.ResponseWriter, r *http.Request) HandlerError {
		w.Write([]byte("pv"))
		return nil
	})
	pathVar.MethodNotAllowed(func(w http.ResponseWriter, r *http.Request) HandlerError {
		w.WriteHeader(405)
		w.Write([]byte("pv 405"))
		return nil
	})
...
func TestMuxSubroutes(t *testing.T) {
	...
	r.Get("/hubs/{hubID}/users/", func(w http.ResponseWriter, r *http.Request) HandlerError {
...
func TestMuxEmptyParams(t *testing.T) {
	r := NewRouter()
	r.Get(`/users/{x}/{y}/{z}`, func(w http.ResponseWriter, r *http.Request) HandlerError {
		x := URLParam(r, "x")
		y := URLParam(r, "y")
		z := URLParam(r, "z")
...
func TestMuxWildcardRoute(t *testing.T) {
	handler := func(w http.ResponseWriter, r *http.Request) HandlerError { return nil }
...
func TestMuxRegexp2(t *testing.T) {
	r := NewRouter()
	r.Get("/foo-{suffix:[a-z]{2,3}}.json", func(w http.ResponseWriter, r *http.Request) HandlerError {
...
func TestMuxRegexp3(t *testing.T) {
	r := NewRouter()
	r.Get("/one/{firstId:[a-z0-9-]+}/{secondId:[a-z]+}/first", func(w http.ResponseWriter, r *http.Request) HandlerError {
		w.Write([]byte("first"))
		return nil
	})
	r.Get("/one/{firstId:[a-z0-9-_]+}/{secondId:[0-9]+}/second", func(w http.ResponseWriter, r *http.Request) HandlerError {
		w.Write([]byte("second"))
		return nil
	})
	r.Delete("/one/{firstId:[a-z0-9-_]+}/{secondId:[0-9]+}/second", func(w http.ResponseWriter, r *http.Request) HandlerError {
		w.Write([]byte("third"))
		return nil
	})

	r.Route("/one", func(r Router) {
		r.Get("/{dns:[a-z-0-9_]+}", func(writer http.ResponseWriter, request *http.Request) HandlerError {
			writer.Write([]byte("_"))
			return nil
		})
		r.Get("/{dns:[a-z-0-9_]+}/info", func(writer http.ResponseWriter, request *http.Request) HandlerError {
			writer.Write([]byte("_"))
			return nil
		})
		r.Delete("/{id:[0-9]+}", func(writer http.ResponseWriter, request *http.Request) HandlerError {
